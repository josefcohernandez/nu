...
**Estado:** Aceptada · 2026-06 (**refina** [ADR-010](#adr-010--extensiones-oficiales-distribuidas-con-nu-no-activas-por-defecto); resuelve [G33](problemas.md#g33--el-arranque-sin-tty-no-tiene-onramp-y-el-conjunto-oficial-está-sin-definir))
