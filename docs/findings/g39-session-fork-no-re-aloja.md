...
**Resolución** (aplicada en [agente.md](../contracts/agente.md) §2 —firma, párrafo "Fork y cierre" y nota de estado— y [sesiones.md](../contracts/sesiones.md) §5): la opción (c) con las tres sub-decisiones. Crecimiento por adición: `fork(at?)` sigue válido.
