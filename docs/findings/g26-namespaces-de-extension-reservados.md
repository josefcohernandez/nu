...
**Resolución** (aplicada en [api.md](../contracts/api.md) §4 y §14, [guia-plugins.md](../contracts/guia-plugins.md)
§7 y [agente.md](../contracts/agente.md) §4): esquema de **dos niveles**, sin reservar
...
sus propias capacidades» ([filosofia.md](../core/filosofia.md) §2, ADR-003) — la
...
namespaces de eventos reservados, mientras [api.md](../contracts/api.md) (§4, §17) reserva
