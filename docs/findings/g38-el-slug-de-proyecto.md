...
**Resolución** (aplicada en [sesiones.md](../contracts/sesiones.md) §2): la opción (c), con el **algoritmo actual congelado tal cual**. Dos piezas:
