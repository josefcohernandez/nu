...
> **codecs, re, fs, sys, log, text (width/truncate), http.request, ws y search** del
> catálogo, más el **despacho de métodos-de-handle ⏸ validado** (desbloquea
> Proc/Ws/Stream). Faltan: text-Blocks (M13c), http.stream y proc (handles
