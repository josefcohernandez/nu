...
> **▶ Próxima sesión: `M09`** (primitivas de IO/datos como host functions —
> mecánico gracias a M05). Pendientes arrastrados a la integración: el
> **watchdog por época** (DM4) y el **input de UI** (con M11). · Bitácora abajo.
